      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-scale-in">
          ...
          <Button 
            ...
            variant="outline"
            size="lg"
            className="border-2 border-primary-foreground/80 text-primary-foreground hover:bg-primary-foreground/20 hover:border-primary-foreground hover:scale-110 backdrop-blur-sm transition-all duration-500 text-xl px-12 py-6 font-bold rounded-full"
          >
            ☕ Discover Our Story
          </Button>
        </div>
